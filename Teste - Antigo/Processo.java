...
public class Processo {
    ...
    private static final int TAMANHO_MENSAGEM = 15;  // Defina o tamanho da mensagem conforme necessário
    ...
    private String criarMensagem() {
        int identificador = 1;  // Defina o identificador apropriado
        int idProcesso = this.getPid();
        String mensagem = identificador + "|" + idProcesso + "|000000";  // Adapte conforme necessário

        // Certifique-se de que a mensagem tenha o tamanho fixo necessário
        if (mensagem.length() < TAMANHO_MENSAGEM) {
            mensagem = String.format("%-" + TAMANHO_MENSAGEM + "s", mensagem);
        }
